...
<head>
    <meta charset="UTF-8">
    <title>Вхід до кабінету — Pâtisserie</title>
    <style>
        ...
        .error-msg { color: red; font-size: 0.85rem; margin-bottom: 10px; text-align: left; }
    </style>
</head>
<body>
...
<div class="auth-card">
    ...
    <form action="/login" method="POST">
        ...
        <div class="form-group">
            <label>Пароль</label>
            <input type="password" name="password" placeholder="Твій пароль" required>
        </div>
        <button type="submit" class="btn-submit">Увійти</button>
    </form>
    <a href="/register" class="auth-link">Не маєте акаунту? <span>Зареєструватися</span></a>
</div>
